...
Tất cả các khoản tín dụng gừi đến tác giả.
'''
...
LOGITS_PROCESSOR_INPUTS_DOCSTRING = r"""
    Args:
        ...
        scores (`torch.FloatTensor` of shape `(batch_size, config.vocab_size)`):
            Điểm dự đoán của người đứng đầu mô hình hóa ngôn ngữ. Đây có thể là logs cho từng từ vựng khi không sử dụng chùm
            tìm kiếm hoặc ghi lại softmax cho từng mã thông báo từ vựng khi sử dụng tìm kiếm chùm
...
class GrammarConstrainedLogitsProcessor(LogitsProcessor):
    ...
    def process_logits(self, input_ids, scores, parse_start_index=None):
        ...
        #  (i.e., one token at a time).
            ...
            raise RuntimeError(
                "Độ dài của ID đầu vào không nhất quán với trạng thái hiện tại của "
                "bộ xử lý GrammarConsbbedLogits. Nếu bạn muốn xử lý "
                "một chuỗi đầu vào khác, vui lòng khởi tạo một chuỗi mới "
