"""
Mô-đun này chịu trách nhiệm sửa đổi lời nhắc và lịch sử trò chuyện.
"""
import re
...
def _hijack_last(context_text: str, history: dict, max_len: int, state: dict):
    ...
    if replace_position is None:
        logger.warn("context_text được cung cấp quá dài để thay thế bất kỳ tin nhắn nào trong lịch sử.")
    else:
